      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Muhammad Abyan Farras Yusuf</h4>
            <p><em>Dedicated software engineer with a passion for innovation, problem-solving, and making a positive impact.</em></p>
            <p>
            <ul>
              <li>Sleman, Yogyakarta</li>
              <li>+62 812-2345-1234</li>
              <li>muhammadabyanfarrasyusuf@mail.ugm.ac.id</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>Applied undergraduate Software Engineering</h4>
            <h5>2022 - now</h5>
            <p><em>Universitas Gadjah Mada, Sleman, DIY</em></p>
            <p>Applied undergraduate Software Engineering Student at . I am passionate Software Engineer. As a Developer, I have hands-on experience in Python, JavaScript, Java, C++, PHP, and many other programming languages.</p>
          </div>
          <div class="resume-item">
            <h4>High School Diploma in Mathematics and Natural Science</h4>
            <h5>2018 - 2021</h5>
            <p><em>Senior High School 4 Kendari</em></p>
            <p>Just a regular high school student.</p>
          </div>
        </div>
        <div class="col-lg-6">
          <h3 class="resume-title">Professional Experience</h3>
          <div class="resume-item">
            <h4>graphic design co-lead</h4>
            <h5>2022 - Now</h5>
            <p><em>One Week Wonder Studio, Sleman, DIY </em></p>
            <p>
            <ul>
              <li>Collaborate in the design, development, and implementation of the graphic, layout, and production communication materials.</li>
          ...
          <div class="resume-item">
            ...
            <h5>2020 - 2021</h5>
            <p><em>Arstar Creative Studio, Kendari, Sultra</em></p>
            <p>
            <ul>
              <li>Assisted in the development of various marketing materials such as logos, brochures, infographics, presentations, and advertisements.</li>
              <li>Managed up to 3 projects or tasks at a given time while under pressure.</li>
              <li>Supported senior designers in executing design concepts and refining visual assets.</li>
              <li>Actively participated in team meetings, brainstorming sessions, and professional development opportunities.</li>
            </ul>
            </p>
          </div>
        </div>
  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <form action="#" method="post" class="mt-4">
        ...
        <div class="text-center send-button"><button type="submit" name="send_message">Send Message</button></div>
      </form>
